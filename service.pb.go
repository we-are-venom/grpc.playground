...
type Book struct {
	...
	Status Status `protobuf:"varint,4,opt,name=status,proto3,enum=we.are.venom.Status" json:"status,omitempty"`
}
...
func init() {
	proto.RegisterEnum("we.are.venom.Status", Status_name, Status_value)
	proto.RegisterType((*Book)(nil), "we.are.venom.Book")
	proto.RegisterType((*GetBookRequest)(nil), "we.are.venom.GetBookRequest")
}
...
var fileDescriptor_a0b84a42fa06f626 = []byte{
	...
	0xcb, 0x4c, 0x4e, 0xd5, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0xe2, 0x29, 0x4f, 0xd5, 0x4b, 0x2c,
	0x4a, 0xd5, 0x2b, 0x4b, 0xcd, 0xcb, 0xcf, 0x55, 0x2a, 0xe3, 0x62, 0x71, 0xca, 0xcf, 0xcf, 0x16,
	...
	,
}
...
func (c *bookServiceClient) GetBook(ctx context.Context, in *GetBookRequest, opts ...grpc.CallOption) (*Book, error) {
	out := new(Book)
	err := c.cc.Invoke(ctx, "/we.are.venom.BookService/GetBook", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BookService_GetBook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/we.are.venom.BookService/GetBook",
	}
...
var _BookService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "we.are.venom.BookService",
